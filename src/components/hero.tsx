...
<section className="relative w-full h-screen">
  ...
  {/* Content */}
  <div className="relative z-10 flex flex-col items-center justify-center h-full text-center px-4 md:px-0 transform -translate-y-10 md:-translate-y-12">
    
    {/* #1 Text */}
    <div className="text-yellow-500 uppercase tracking-widest mb-4 text-sm md:text-base font-serif italic">
    ...
    <Link to='/about'>
      <button className="bg-black text-yellow-300 mt-6 px-6 py-3 rounded-lg text-lg font-semibold hover:bg-yellow-600 transition">
        About Us
      </button>
    </Link>
  </div>
